...
class MonthLevelDataProcessor(ConfigReportMixin):
    ...
    def process_records(self) -> ProcessorResult:
        ...
        self.logger.info("Starting MonthLevelDataProcessor ...")
        ...
        try:
            ...
            unfinished_df = self._analyze_unfinished_pos(combined_df, analysis_timestamp)
            ...
            #analysis_timestamp, adjusted_record_month, processed_data, final_summary
            return ProcessorResult(
                processor_level = ProcessorLevel.MONTH,
