...
from agents.dashboardBuilder.plotters.month_level.plot_backlog_analysis import plot_backlog_analysis
from agents.dashboardBuilder.plotters.month_level.plot_capacity_severity import plot_capacity_severity
from agents.dashboardBuilder.plotters.month_level.plot_capacity_warning_matrix import plot_capacity_warning_matrix
...
from agents.dashboardBuilder.plotters.month_level.plot_mold_nums import plot_mold_nums
from agents.dashboardBuilder.plotters.month_level.plot_overdue_analysis import plot_overdue_analysis
from agents.dashboardBuilder.plotters.month_level.plot_po_status_pie import plot_po_status_pie
from agents.dashboardBuilder.plotters.month_level.plot_progress_bar import plot_progress_bar
from agents.dashboardBuilder.plotters.month_level.plot_progress_distribution import plot_progress_distribution
from agents.dashboardBuilder.plotters.month_level.plot_top_items_bar import plot_top_items_bar
from agents.dashboardBuilder.plotters.month_level.plot_top_ng_items_bar import plot_top_ng_items_bar
from agents.dashboardBuilder.plotters.month_level.plot_ng_rate import plot_ng_rate
...
def year_performance_plotter(unfinished_df: pd.DataFrame,
        ...
        try:
            ...
            plot_overdue_analysis(fig.add_subplot(gs[2, 1]), unfinished_df, colors, sizes)
            plot_capacity_warning_matrix(fig.add_subplot(gs[2, 2]), unfinished_df, colors, sizes)
            plot_top_items_bar(fig.add_subplot(gs[3:5, :]), unfinished_df, colors, sizes)
            plot_capacity_severity(fig.add_subplot(gs[5, 0]), unfinished_df, colors, sizes)
            plot_progress_distribution(fig.add_subplot(gs[5, 1]), unfinished_df, colors, sizes)
            plot_mold_nums(fig.add_subplot(gs[5, 2]), all_progress_df, colors, sizes)
            plot_late_items_bar(fig.add_subplot(gs[6, :]), unfinished_df, colors, sizes)
