...
- **Visualization Outputs** (11 files total):
    
    **Excel Exports (3 files)**:
    1. **Tonage_machine_mold_not_matched.xlsx**: Records where mold tonnage doesn't match machine tonnage
    2. **Machine_mold_first_run_pair.xlsx**: Pivot showing first-run dates (machine perspective)
    3. **Mold_machine_first_run_pair.xlsx**: Pivot showing first-run dates (mold perspective)
    
    **PNG Visualizations (8 files)**:
    1. **Comparison_of_acquisition_and_first_use.png**:
    ...
    2. **Time_Gap_of_acquisition_and_first_use.png**:
    ...
    3. **Top_Bottom_molds_gap_time_analysis.png**:
    ...
    4. **Number_of_molds_first_run_on_each_machine.png**:
