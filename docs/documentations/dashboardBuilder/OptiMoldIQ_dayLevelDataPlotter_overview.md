...
- **Visualization Outputs** (9 files total):
    
    **Excel Export (1 file)**:

    1. **{timestamp}_extracted_records_{date}.xlsx**: 
   
    - 4 sheets generated by: `DayLevelDataProcessor` ([→ see detail](https://github.com/ThuyHaLE/OptiMoldIQ/blob/main/docs/documentations/analyticsOrchestrator/multiLevelDataAnalytics/OptiMoldIQ_dayLevelDataProcessor_overview.md)) 
    ...
    - *1.1. Sheet 1 — `selectedDateFilter`*: 
    ...
    **PNG Visualizations (8 files)**:
    ...
    1. **change_times_all_types_fig_{date}.png**:
    ...
    2. **item_based_overview_dashboard_{date}.png**:
    ...
    3. **machine_level_yield_efficiency_chart_{date}.png**:
    ...
    4. **machine_level_mold_analysis_chart_{date}.png**:
    ...
    5. **mold_based_overview_dashboard_{date}.png**:
    ...
    1. **shift_level_detailed_yield_efficiency_chart_{date}.png**:
    ...
    2.  **shift_level_mold_efficiency_chart_{date}.png**:
    ...
    8. **shift_level_yield_efficiency_chart_{date}.png**:
