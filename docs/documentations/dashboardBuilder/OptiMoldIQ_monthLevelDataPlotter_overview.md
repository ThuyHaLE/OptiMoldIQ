...
- **Visualization Outputs** (6+ files total):
    
    1. **{timestamp}_extracted_records_{month}.xlsx**: 

    - 2 sheets (`finished_df`, `unfinished_df`) generated by: `MonthLevelDataProcessor` ([→ see detail](https://github.com/ThuyHaLE/OptiMoldIQ/blob/main/docs/documentations/analyticsOrchestrator/multiLevelDataAnalytics/OptiMoldIQ_monthLevelDataProcessor_overview.md)) 
    ...
    - 3 sheets (`short_unfinished_df`, `all_progress_df`, `filtered_df`) generated by `MonthLevelDataPlotter`: 
      ...
      - *Data Flow Relationships*:
        ```
                ...
                │     : One-to-many relationship (aggregation)
    ...
    **TXT Reports (2 files)**:
    ...
    1. **{timestamp}_final_summary_{month}.txt**: 
        
        - `final_summary` generated by: `MonthLevelDataProcessor` ([→ see detail](https://github.com/ThuyHaLE/OptiMoldIQ/blob/main/docs/documentations/analyticsOrchestrator/multiLevelDataAnalytics/OptiMoldIQ_monthLevelDataProcessor_overview.md))  
    ...
    2. **{timestamp}_early_warning_report_{month}.txt**:
        
        - `early_warning_report` generated by: `MonthLevelDataPlotter`
        ...
        - *Key Metrics*:
            ...
            | Capacity Warning              | Number of POs flagged with `capacityWarning = True` — potential overcapacity risks                               |
            | Overall Risk Score            | Composite score calculated as *(10×critical + 5×high + 3×overdue + 2×backlog)* to quantify production risk level |
            | Overall Risk Level            | Categorized based on score: `🟢 MODERATE`, `🟡 HIGH`, or `🔴 CRITICAL`                                           |

    **PNG Visualizations (3+ files, potentially multi-page)**:

    3. **machine_based_dashboard_{month}.png**:
        ...
        - *Purpose*:
          ...
          - Provides an at-a-glance visualization of multi-metric machine performance — such as production quantity, NG rate, working shifts, and downtime.
        ...
        - *Output Features*:
            ...
            | ------------------------------------ | -------------------------- | ------------------------------------------------------ |
            | `machine_based_dashboard_{date}.png` | `.png` image               | Composite bar chart dashboard (machines × metrics)     |
    ...
    4. **mold_based_dashboard_{month}.png**:
        ...
        - *Processing Logic*:
          ...
          - Visualization Setup: figure layout (16×16 default).  
          - Plotting Workflow:
        ...
        - *Output Features*:
            | Output                               | Type                       | Description                                            |
            | ------------------------------------ | -------------------------- | ------------------------------------------------------ |
            | `mold_based_dashboard_{date}.png`    | `.png` image               | Composite bar chart dashboard (molds × metrics)        |
            ...
            | **Legend**                           | Auto-generated             | Maps index → moldNo → color                            |
            | **Title**                            | `fig_title` string         | Displays overall dashboard title above figure          |

    5. **month_performance_dashboard_{month}.png**:
