...
Data prepared for day-level dashboards. Sheets mirror `day_level_data_processor_result.xlsx` from `AnalyticsOrchestrator` — see [AnalyticsOrchestrator — day_level_data_processor_result](docs/v3/demo/output_format/AnalyticsOrchestrator/analytics_orchestrator.md#day_level_data_processor_resultxlsx) for full schema.
...
Same columns as `productRecords.parquet` (see [DataPipelineOrchestrator](docs/v3/demo/output_format/DataPipelineOrchestrator/data_pipeline_orchestrator.md#productrecordsparquet)), plus:
