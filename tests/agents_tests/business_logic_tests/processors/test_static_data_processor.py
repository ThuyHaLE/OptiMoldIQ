...
class TestStaticDataProcessorInit:
    """Test cases for StaticDataProcessor initialization"""
    
    def test_init_with_default_schema_item_composition(self):
        """Test initialization with default itemCompositionSummary schema"""
    ...
    def test_init_with_default_schema_item_info(self):
        """Test initialization with default itemInfo schema"""
    ...
    def test_init_with_default_schema_machine_info(self):
        """Test initialization with default machineInfo schema"""
    ...
    def test_init_with_default_schema_mold_info(self):
        """Test initialization with default moldInfo schema"""
    ...
    def test_init_with_default_schema_mold_specification(self):
        """Test initialization with default moldSpecificationSummary schema"""
    ...
    def test_init_with_default_schema_resin_info(self):
        """Test initialization with default resinInfo schema"""
    ...
    def test_init_with_custom_schema(self):
        """Test initialization with custom schema override"""
        custom_schema = {
            'itemInfo': {
                'path': '/custom/path/itemInfo.xlsx',
                'dtypes': {
                    'itemCode': 'string',
                    'itemName': 'string',
                    'customField': 'int64'
        ...
        assert processor.path == '/custom/path/itemInfo.xlsx'
        assert 'customField' in processor.dtypes
        assert processor.dtypes['customField'] == 'int64'
    
    def test_init_with_partial_custom_schema(self):
        """Test initialization with partial schema override"""
        custom_schema = {
            'itemInfo': {
                'path': '/new/path.xlsx'
                # dtypes not provided, should use default
            }
        }
        ...
        assert processor.path == '/new/path.xlsx'
        # Dtypes should still be from default
        assert processor.dtypes['itemCode'] == 'string'
        assert processor.dtypes['itemName'] == 'string'
    
    def test_init_with_none_database_schema(self):
        """Test initialization with None database_schema"""
        processor = StaticDataProcessor(
            data_name='itemInfo',
    ...
    def test_schema_deep_copy(self):
        ...
        original_schema['itemInfo']['path'] = '/modified/path.xlsx'
        
        # Processor should have the original path
        assert processor.path == '/original/path.xlsx'
