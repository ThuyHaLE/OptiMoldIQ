...
def test_data_change_analyzer():
    analyzer = DataChangeAnalyzer(
      ...
      machine_layout_output_dir = "tests/shared_db/DataChangeAnalyzer/UpdateHistMachineLayout",
      mold_overview_output_dir = "tests/shared_db/DataChangeAnalyzer/UpdateHistMoldOverview",
