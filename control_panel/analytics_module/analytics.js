// analytics.js — AnalyticsViz component (Babel standalone, global vars)
// Depends on: config.js (C, TYPE_COLORS, MACHINE_COLORS, MONTH_PALETTE, monthColor, monthBg, defectColor, etaColor, statusColor, ngColor)
...
// ── ANALYTICSviz — ROOT COMPONENT ────────────────────────────

function AnalyticsViz({ data }) {
  layout                  = data.MachineLayoutTracker.machineLayoutChange;
  machineMoldFirstRunPair = data.MoldMachinePairTracker.machineMoldFirstRunPair;
  moldMachineFirstRunPair = data.MoldMachinePairTracker.moldMachineFirstRunPair;
  DayLevelDataProcessor   = data.DayLevelDataProcessor;
  MonthLevelDataProcessor = data.MonthLevelDataProcessor;
  YearLevelDataProcessor  = data.YearLevelDataProcessor;
...
window.AnalyticsViz = AnalyticsViz;
